<?php
    ...
    if(isset($_POST["add"])){
        ...
        if(isset($_SESSION["cart-earphones"])){
            $item_array_id = array_column($_SESSION["cart-earphones"],"product_id");
            //print_r($item_array_id);
            if(in_array($_POST["product_id"],$item_array_id)){
                echo "<script>alert('product is already added!!!!')</script>";
                echo "<script>window.location = 'index.php'</script>";
            }else{
                $count = count($_SESSION["cart-earphones"]);
                //print_r($count);
                $item_array = array(
                    'product_id' => $_POST['product_id']
                );
                $_SESSION["cart-earphones"][$count] = $item_array;
                //print_r($_SESSION["cart-earphones"]);
            }
            //print_r($_SESSION["cart-earphones"]);
        }else{
            $item_array = array(
            ...
            $_SESSION["cart-earphones"][0]= $item_array;
            //print_r($_SESSION["cart-earphones"]);
        }
    }
    //session_destroy();
...
<head>
    ...
    <title>Earphones | Hari collection</title>
            ...
            <div class="col-md-2 col-sm-2 list">
                ...
                <div class="list-group">
					...
					<?php
                        ...
                        $query = "SELECT DISTINCT(product_brand) FROM earphones WHERE product_status = '1' ORDER BY product_id DESC";
