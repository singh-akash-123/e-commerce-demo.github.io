<?php
    ...
    $search = "SELECT * FROM speakers WHERE product_id=$get_product";
    $result_search = mysqli_query($connection,$search);
    $search_num = mysqli_num_rows($result_search);
    if($search_num){
                ...
                <?php
                    ...
                    if(mysqli_num_rows($result) > 0){
                        while($row = mysqli_fetch_array($result)){
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <div class="img-container">
                                <img src="image/image-'. $row['product_id'] .'.jpeg" alt="" class="img-responsive" >
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-6 col-md-6">
