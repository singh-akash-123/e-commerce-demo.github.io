<?php
    ...
    if(isset($_POST["add"])){
        ...
        if(isset($_SESSION["cart-chargers"])){
            $item_array_id = array_column($_SESSION["cart-chargers"],"product_id");
            //print_r($item_array_id);
            if(in_array($_POST["product_id"],$item_array_id)){
                echo "<script>alert('product is already added!!!!')</script>";
                echo "<script>window.location = 'index.php'</script>";
            }else{
                $count = count($_SESSION["cart-chargers"]);
                //print_r($count);
                $item_array = array(
                    'product_id' => $_POST['product_id']
                );
                $_SESSION["cart-chargers"][$count] = $item_array;
                //print_r($_SESSION["cart-chargers"]);
            }
            ...
            $_SESSION["cart-chargers"][0]= $item_array;
            //print_r($_SESSION["cart-chargers"]);
        }
    }
?>
...
<head>
    ...
    <title>Chargers | Hari Collection</title>
        ...
        <div class="row">
            <div class="col-sm-2 col-md-2 list">
				<div class="list-group">
                    ...
                    <input type="hidden" id="hidden_maximum_price" value="2500" />
                    <p id="price_show">100 - 2500</p>
                ...
                <div class="list-group">
					...
					<?php
                        ...
                        $query = "SELECT DISTINCT(product_brand) FROM chargers WHERE product_status = '1' ORDER BY product_id DESC";
